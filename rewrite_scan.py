...
# Remove old widgets to avoid unused class warnings
text = re.sub(r'class _SelectedImagePreview extends StatelessWidget \{.*?\}\n\}', '', text, flags=re.DOTALL)
text = re.sub(r'class _ImageEmptyState extends StatelessWidget \{.*?\}\n\}', '', text, flags=re.DOTALL)
